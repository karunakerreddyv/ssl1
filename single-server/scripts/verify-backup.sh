...
verify_backup_contents() {
    ...
    for volume in "uploads.tar.gz" "ml_models.tar.gz" "superset_home.tar.gz" "ml_storage.tar.gz" "training_data.tar.gz" "plugins.tar.gz" "solution_packs.tar.gz" "celery_beat_schedule.tar.gz" "workflow_configs.tar.gz" "jupyter_notebooks.tar.gz" "jupyter_data.tar.gz"; do
